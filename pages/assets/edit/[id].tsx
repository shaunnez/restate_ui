...
export const AssetEdit = (props: any) => {
  ...
  const {
    ...
    reset,
    watch,
  } = useForm({ refineCoreProps: { resource: "assets", id } });
        ...
        <Edit isLoading={formLoading} saveButtonProps={saveButtonProps}>
          ...
          >
            ...
            <DateTimePicker
              ...
              value={item?.purchased_date ? moment(item?.purchased_date) : ""}
            ...
            <DateTimePicker
              label="Tagging Date"
              value={item?.tagging_date ? moment(item?.tagging_date) : ""}
              format="DD/MM/YYYY HH:mm"
              onChange={(value) => {
            ...
            <DateTimePicker
              ...
              value={
                item?.future_tagging_date
                  ? moment(item?.future_tagging_date)
                  : ""
              }
              format="DD/MM/YYYY HH:mm"
              onChange={(value) => {
            ...
            <DateTimePicker
              label="Service Date"
              value={item?.service_date ? moment(item?.service_date) : ""}
              format="DD/MM/YYYY HH:mm"
              onChange={(value) => {
            ...
            <DateTimePicker
              ...
              value={
                item?.future_service_date
                  ? moment(item?.future_service_date)
                  : ""
              }
              format="DD/MM/YYYY HH:mm"
              onChange={(value) => {
